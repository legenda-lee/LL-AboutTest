package com.legenda.lee.studyStream.aboutGroupingBy;
...
public class Test1 {
    ...
    public static void main(String[] args) {
        ...
        Map<String, List<MedicineDTO>> result = whiteDoctorValue.stream().collect(Collectors.groupingBy(MedicineDTO::getDrugName));
